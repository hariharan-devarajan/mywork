 ...
 *  and write it collective on file using MPI-IO                              *
 *                                                                            *
 *****************************************************************************/
...
int main(argc, argv)
	...
	int my_rank, pool_size, number_of_blocks = 10, i, count;
	char *filename = NULL;
	int filename_length;
	int *junk;
	int number_of_integers=1, number_of_bytes;
...
#endif
	number_of_integers = 1*number_of_blocks;
